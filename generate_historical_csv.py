"""
Generate clean f1_historical_5years.csv from FastF1 API
Extracts qualifying + race results for 2020-2024 seasons
"""
...
print("="*70)
print("[GENERATOR] F1 Historical Data CSV - FastF1 Direct")
print("="*70)
...
for year in years:
    ...
    try:
        ...
        print(f"  ❌ Could not load schedule: {str(e)[:50]}")
    ...
    for idx, (_, event_row) in enumerate(schedule.iterrows()):
        try:
            ...
            # Circuit might not be in schedule, try to get from session
            circuit = 'Unknown'
            ...
            # Load RACE session to get finishing positions
            ...
            # Extract each driver's finishing position
            for driver_idx, driver_row in race_data.iterrows():
                try:
                    ...
                    # Only keep finished positions (1-20)
                    if finish_pos is None or finish_pos > 20:
                        continue
                    
                    # Get constructor/team
                    ...
                    record = {
                        ...
                        'driver_age': None,  # Would need additional data
                        'constructor': str(constructor),
                        'grid_position': grid_pos,
                        'finish_position': finish_pos,
                        'points_constructor': 100.0,  # Placeholder
