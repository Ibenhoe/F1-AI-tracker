  ...
  if (!data) {
    return (
      <div className="space-y-3">
        ...
        <div className="h-24 rounded-xl border border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-950/40" />
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h2 className="text-sm font-semibold tracking-tight">Race</h2>
          <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">{data.race}</p>
        </div>
      ...
      <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950/40">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-neutral-600 dark:text-neutral-400">Lap progress</span>
          </div>
          <div className="flex items-center gap-2">
            <Gauge size={16} className="text-neutral-500" />
            <span className="text-xs text-neutral-700 dark:text-neutral-300">{progressPct}%</span>
          </div>
        </div>
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-neutral-600 dark:text-neutral-500">
          <span>Start</span>
          <span>Finish</span>
        </div>
      </div>
